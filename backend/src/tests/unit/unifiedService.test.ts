...
// Mocks
vi.mock('../../services/user/watchlistService.js', () => ({
  getWatchlist: vi.fn().mockResolvedValue(['WARM1', 'WARM2'])
}));
vi.mock('../../services/user/focusService.js', () => ({
  getFocus: vi.fn().mockResolvedValue({ assetId: 'HOT1', until: '2099-01-01' })
}));
vi.mock('../../services/signals/oracleService.js', () => ({
...
vi.mock('../../services/signals/dailyBiasService.js', () => ({
...
vi.mock('../../services/signals/pulseService.js', () => ({
