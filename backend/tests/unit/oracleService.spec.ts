...
import { getOracleCards } from '../../src/services/signals/oracleService.js';

vi.mock('../../src/adapters/market/marketAdapter.js', () => ({
...
vi.mock('../../src/adapters/onchain/onchainAdapter.js', () => ({
