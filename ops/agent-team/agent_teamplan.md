...
| WS-002 | MSPR-Packet für Bootstrap | Orchestrator | `governance_change` | `03-mspr/packets/2026-06-08-swarm-governance-bootstrap.yaml` | Tier 2 | active | MSPR-Packet für Bootstrap anlegen | ja (menschlich) |
...
- Jupiter-Live-Provider: Tier 0 / Human Approval, bis DNS und Origin verifiziert.
...
- Governance- und Policy-Änderungen: Tier 3 + menschlicher Review
  (gemäß `AGENTS.md` Stop-Rule).

## Next Gate

Kleinster sicherer Schritt: einen Read-Only-Audit-Workstream (`WS-003`)
anlegen, der die Routing-Tabelle gegen `02-wiki/` (read-only) prüft
